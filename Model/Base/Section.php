...
abstract class Section implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Section\\Model\\Map\\SectionTableMap';
    ...
    /**
     * Initializes internal state of Section\Model\Base\Section object.
     */
     ...
     *
     * @return Section The current object, for fluid interface
     */
     ...
     * @return   \Section\Model\Section The current object (for fluent API support)
     */
    ...
    public function setVisible($v)
    {
        ...
        if ($this->visible !== $v) {
            $this->visible = $v;
            $this->modifiedColumns[SectionTableMap::VISIBLE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[SectionTableMap::CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[SectionTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SectionTableMap::translateFieldName('Visible', TableMap::TYPE_PHPNAME, $indexType)];
            $this->visible = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SectionTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, '\DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SectionTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 4; // 4 = SectionTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \Section\Model\Section object", 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(SectionTableMap::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(SectionTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(SectionTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->sectionI18nsScheduledForDeletion !== null) {
                if (!$this->sectionI18nsScheduledForDeletion->isEmpty()) {
                    \Section\Model\SectionI18nQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SectionTableMap::VISIBLE)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collSectionI18ns) {
                $result['SectionI18ns'] = $this->collSectionI18ns->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SectionTableMap::ID)) $criteria->add(SectionTableMap::ID, $this->id);
        if ($this->isColumnModified(SectionTableMap::VISIBLE)) $criteria->add(SectionTableMap::VISIBLE, $this->visible);
        if ($this->isColumnModified(SectionTableMap::CREATED_AT)) $criteria->add(SectionTableMap::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(SectionTableMap::UPDATED_AT)) $criteria->add(SectionTableMap::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(SectionTableMap::DATABASE_NAME);
        $criteria->add(SectionTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Section\Model\Section (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Section\Model\Section Clone of current object.
     * @throws PropelException
     */
    ...
    public function initSectionI18ns($overrideExisting = true)
    {
        ...
        $this->collSectionI18ns = new ObjectCollection();
        $this->collSectionI18ns->setModel('\Section\Model\SectionI18n');
    }
     ...
     * @return Collection|ChildSectionI18n[] List of ChildSectionI18n objects
     * @throws PropelException
     */
    public function getSectionI18ns($criteria = null, ConnectionInterface $con = null)
    {
    ...
    /**
     * Sets a collection of SectionI18n objects related by a one-to-many relationship
    ...
    public function addSectionI18n(ChildSectionI18n $l)
    {
        ...
        if (!in_array($l, $this->collSectionI18ns->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    /**
     * @param SectionI18n $sectionI18n The sectionI18n object to add.
     */
    protected function doAddSectionI18n($sectionI18n)
    {
    ...
    /**
     * @param  SectionI18n $sectionI18n The sectionI18n object to remove.
     * @return ChildSection The current object (for fluent API support)
     */
    public function removeSectionI18n($sectionI18n)
    {
        if ($this->getSectionI18ns()->contains($sectionI18n)) {
            $this->collSectionI18ns->remove($this->collSectionI18ns->search($sectionI18n));
