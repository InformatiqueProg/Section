...
use Section\Model\SectionI18n;
use Section\Model\SectionI18nQuery;
...
class SectionI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Section.Model.Map.SectionI18nTableMap';
     ...
     */
    const OM_CLASS = '\\Section\\Model\\SectionI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Section.Model.SectionI18n';
     ...
     */
    const ID = 'section_i18n.ID';

    /**
     * the column name for the LOCALE field
     */
    const LOCALE = 'section_i18n.LOCALE';

    /**
     * the column name for the TITLE field
     */
    const TITLE = 'section_i18n.TITLE';

    /**
     * the column name for the DESCRIPTION field
     */
    const DESCRIPTION = 'section_i18n.DESCRIPTION';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SectionI18nTableMap::ID, SectionI18nTableMap::LOCALE, SectionI18nTableMap::TITLE, SectionI18nTableMap::DESCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SectionI18nTableMap::ID => 0, SectionI18nTableMap::LOCALE => 1, SectionI18nTableMap::TITLE => 2, SectionI18nTableMap::DESCRIPTION => 3, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Section\\Model\\SectionI18n');
        $this->setPackage('Section.Model');
    ...
    {
        $this->addRelation('Section', '\\Section\\Model\\Section', RelationMap::MANY_TO_ONE, array('id' => 'id', ), 'CASCADE', null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \Section\Model\SectionI18n $obj A \Section\Model\SectionI18n object.
     ...
     *
     * @param mixed $value A \Section\Model\SectionI18n object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Section\Model\SectionI18n) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Section\Model\SectionI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SectionI18nTableMap::ID);
            $criteria->addSelectColumn(SectionI18nTableMap::LOCALE);
            $criteria->addSelectColumn(SectionI18nTableMap::TITLE);
            $criteria->addSelectColumn(SectionI18nTableMap::DESCRIPTION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Section\Model\SectionI18n) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(SectionI18nTableMap::ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(SectionI18nTableMap::LOCALE, $value[1]));
        ...
        if ($values instanceof Criteria) { SectionI18nTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { SectionI18nTableMap::removeInstanceFromPool($singleval);
            }
        }
