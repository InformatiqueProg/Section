...
class SectionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Section.Model.Map.SectionTableMap';
     ...
     */
    const OM_CLASS = '\\Section\\Model\\Section';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Section.Model.Section';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SectionTableMap::ID, SectionTableMap::VISIBLE, SectionTableMap::CREATED_AT, SectionTableMap::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SectionTableMap::ID => 0, SectionTableMap::VISIBLE => 1, SectionTableMap::CREATED_AT => 2, SectionTableMap::UPDATED_AT => 3, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Section\\Model\\Section');
    ...
    {
        $this->addRelation('SectionI18n', '\\Section\\Model\\SectionI18n', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null, 'SectionI18ns');
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SectionTableMap::ID);
            $criteria->addSelectColumn(SectionTableMap::VISIBLE);
            $criteria->addSelectColumn(SectionTableMap::CREATED_AT);
            $criteria->addSelectColumn(SectionTableMap::UPDATED_AT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Section\Model\Section) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(SectionTableMap::DATABASE_NAME);
            $criteria->add(SectionTableMap::ID, (array) $values, Criteria::IN);
        }

        $query = SectionQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { SectionTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { SectionTableMap::removeInstanceFromPool($singleval);
            }
        }
